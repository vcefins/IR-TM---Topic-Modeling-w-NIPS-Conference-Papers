...
# parameters for determining the amount of topics and displayed importand words
num_topics = 20
n_top_words = 20
...
for paper in text:
    list_of_words = [i.lower() for i in word_tokenize(paper) if i.lower() not in stop_words]
